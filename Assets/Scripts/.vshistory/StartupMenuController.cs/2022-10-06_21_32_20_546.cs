...
public class StartupMenuController : MonoBehaviour
{
    ...
    private Device player0;
    private Device player1;
    private Device player2;
    private Device player3;
    ...
    void Start()
    {
        ...
        player0 = GameObject.Find("Player 0").GetComponent<Device>();
        player1 = GameObject.Find("Player 1").GetComponent<Device>();
        player2 = GameObject.Find("Player 2").GetComponent<Device>();
        player3 = GameObject.Find("Player 3").GetComponent<Device>();
        ...
        players = new List<Device> { player0, player1, player2, player3 };
